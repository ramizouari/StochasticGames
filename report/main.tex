...
\newcommand{\EdgeSet}{E}
\newcommand{\PlayerSet}{P}
\newcommand{\IndefinitePlayer}{\Opt}
...
\newcommand{\ProjectTitle}{Implementation, Analysis and Predictive modeling of Mean Payoff Games using a Self Learning approach}
...
\pagestyle{fancy}
\fancyhf{}
\chead{\small\ProjectTitle}
\renewcommand{\footrulewidth}{0.4pt}
\cfoot{\thepage \\ \small{\AuthorName}  \\ \scriptsize{INSAT, Tunisia} }
