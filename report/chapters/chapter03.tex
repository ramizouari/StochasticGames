...
To do that, we started by analysing both \acrshort{mpg} datasets that were generated by the end of \ref{chapter:Dataset}. This analysis was crucial to verify some of our hypotheses about \acrshortpl{mpg} that will be implied by the model.
