...
Furthermore, we will introduce informally \acrfullpl{mpg}, then dive into the state of the art in its theory and in \acrfull{ml} approaches. Also, we will briefly introduce learning methods.
...
\end{figure}
\FloatBarrier
\section{Introduction to high power computing}
...
Later, we introduced \acrshortpl{mpg} and described the state of the art. We then introduced briefly learning approaches.
