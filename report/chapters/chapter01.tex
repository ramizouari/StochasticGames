...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		\begin{package}{ games }
			...
			\begin{class}[text width=4cm]{PositionalStrategy}{-2cm,-8cm}
				\inherit{Strategy}
				\operation[0]{+ call(vertex)}
			\end{class}
			
			\begin{class}[text width=4cm]{GreedyStrategy}{-6.5cm,-8cm}
								\inherit{Strategy}
				\operation[0]{+ call(vertex)}
			\end{class}
			\begin{class}[text width=4cm]{EpsGreedyStrategy}{2.5cm,-8cm}
								\inherit{Strategy}
				\operation[0]{+ call(vertex)}
			\end{class}
			
			\begin{class}[text width=4cm]{FractionalStrategy}{7cm,-8cm}
								\inherit{Strategy}
				\operation[0]{+ call(vertex)}
			\end{class}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\small
		\begin{package}{ games }
			\begin{class}[text width=6cm]{MeanPayoffGraphBase}{0,5cm}
			\attribute{edges}
