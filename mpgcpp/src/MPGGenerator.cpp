//
// Created by ramizouari on 17/03/23.
//
#include <iostream>
...
int main(int argc, char *argv[]) {
    ...
    desc.add_options()
            ...
            ("output,o", po::value<std::filesystem::path>(), "Output path for the generated graphs")
            ("verbose,v", po::value<Verbosity>()->default_value(Verbosity::INFO), "Verbosity level (0-3)")
            ("graphw-format", po::value<OutputFormat>()->default_value(OutputFormat::CSV), "Format of the output file")
